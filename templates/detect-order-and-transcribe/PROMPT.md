...
6. PUT every detected line to the page endpoint in a single request (see TPEN API below). The `items` array MUST be in the global reading-order sequence from step 2 — this fixes the page's canonical line order.
